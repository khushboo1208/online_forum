...
<img src="../picture/trans.png" height="27%" width="27%">
...
<textarea name="area" cols="80" rows="10" placeholder="write the content here for the corresponding image to be uploaded..." ></textarea>
</div>
</form>
...
<?php
include('conn.php');
$s="select image from images where category='".$_SESSION['value']."' and flag='i' order by id desc";
...
&nbsp;<a href="img_show.php?id=<?php echo $q['image'];?>"><img class="one" src="../picture/<?php echo $q['image'];?>" width='190' height='140' border='5px'></a>
&nbsp;
