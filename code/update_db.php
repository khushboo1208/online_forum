...
{   ?>
<tr><td><p style="font-family:Calibri;"><font color="white" ><b><?php echo $r['cno'];  ?></b></font></p></td><td><p style="font-family:Calibri;"><font color="white"><b><?php echo $r['cdate'];  ?></b></font></p></td><td><p style="font-family:Calibri;"><font color="white" ><b><?php echo $r['cname'];  ?></b></font></p></td><td><p style="font-family:Calibri;"><font color="white" ><b><a href="update_sql.php?id=<?php echo $r['cno']; ?>">Update</a> | <a href="delete.php?id=<?php $r['cno']; ?>">Delete</a></b></font></p></td></tr>
<?php  }  ?>
</table>
</div></div>
</body></html>