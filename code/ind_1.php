...
$flag=0;
$i=$_REQUEST['search'];
$sel="select * from sections where ipcname='$i'";
...
echo "<br><br><br><br><br><br><br><br><br><center><font FACE='AR JULIAN' size='6.5%' color='red'>"."this ipc name does not exist."."</font></center>";
