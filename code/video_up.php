...
if(move_uploaded_file($temp,"../multimedia/".$name))
echo "uploaded";
else
{ echo"not";
die(mysql_error());
...
<div id="container" style="position:absolute;  top:17%; margin-left:0% ">

<img src="../picture/trans.png" height="27%" width="27%">

</div>
<div id="container" style="position:absolute;  top:32%; margin-left:13.6% ">
<img src="../picture/video_up.png" height="68%" width="68%">
</div>
