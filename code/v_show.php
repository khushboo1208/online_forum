...
include('conn.php');
session_start();
$uid=$_SESSION['video']=$_GET["id"];

$sel="select image,message from images where image='".$uid."' and flag='v'";
...
border-color:black;
 ...
 <div id="container" style="position:absolute;  top:8%; margin-left:3%; ">
 <video width="500" height="500" border='10px' controls>
<source src="../picture/<?php echo $row['image'];?>" type="video/mp4">
</video>
  </div>
 
 <!--   <div id="container" style="position:absolute;  top:88%; margin-left:11.5%; ">
   <form action="down.php" method="POST">
   <button id="new1" type="submit" name="attach"><font color="#FFFF99" size="5%">DOWNLOAD</font></button>
    
    </form>
    </div>    -->
 
 <div id="container" style="position:absolute; top:5%; margin-left:42%; height:15%; width:55%; ">
...
// echo "<img src='myupload/'".$q['image']." width=200 height=400>"
 ?>
 	   ...
 	   <div id="container2.1.1" style="position:absolute; height:53%; left:42.5%; top:22%; width:55%; overflow:scroll;">
	  <center><U><B> YOUR COMMENTS</B></U></center> <br>
	   <?php
 
 include('conn.php');
  $s="select comment,Emailid from commenttb where content='".$uid."' and flag='v' ";
...
<hr>
 ...
 <div id="container" style="position:absolute;  top:77%; margin-left:41.8%; ">
...
<br><br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <button id="new" type="submit" name="attach"><font color="#FFFF99" size="4%">GO</font></button> 
