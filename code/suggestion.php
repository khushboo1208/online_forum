...
$m=mysqli_real_escape_string($conn,$_REQUEST['emailid2']);
$b=mysqli_real_escape_string($conn,$_REQUEST['password2']);
$c=mysqli_real_escape_string($conn,$_REQUEST['suggestion']);
$flag=0;
...
{    
     ...
     {  //echo "id exists";
	  echo '<script language="javascript">';
                 ...
                 echo '</script>';
	 $ins="insert into commenttb(category,content,Emailid,comment,flag) values ('".$a."','".$cn."','".$m."','".$c."','s')";
	 $in=mysqli_query($conn,$ins);
           ...
           if($in)
              ...
              {  $flag=1;
			      echo '<script language="javascript">';
                 echo 'alert(" Thanks for your suggestion. Your suggestion has been recorded. ")';
                 echo '</script>';
