...
<div id="container" style="position:absolute; margin-left:27%; height:20%; margin-top:-1.5%;">
<font color="#000066" face="AR JULIAN" size="10%"><h2> TRANSPORT</h2>
</font>
</div>
...
$sel="select content,Emailid,postno from post where category='TRANSPORT' order by postno desc";
$q=mysqli_query($conn,$sel);
$i=1;
while($data=mysqli_fetch_array($q))
{  echo "&nbsp;&nbsp;&nbsp;&nbsp;";   
 echo "<font size='4px'>"."<b>"."Post ".$i."&nbsp;:"."</b>"."</font>"."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."<a href='../mailing manager/code/registrationpage1.php' >".$data[1]."</a>"."<br>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";echo $data[0]."<br>";   
...
<table>
<tr><a href="write_post.php" title="click here to write new post"><img src="../picture/post2.png"  width="70" height="70"></a>
</tr>
</table>
<br><br>
<table>
<tr><a href="eid_tr.php"><img src="../picture/img_up.png"  width="70" height="70"></a>
</tr> 
</table>
<br><br>
<table>
<tr><a href="eidv_tr.php"><img src="../picture/video_up.png"  width="70" height="70"></a>
</tr>
</table>
</div>
</div>
